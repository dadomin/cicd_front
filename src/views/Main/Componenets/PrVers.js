const PrVers = (props) => {
    ...
    return (
        <div>
            <p>버전선택 (현재 : {ver})</p>
            <div>
                <input type="radio" id="verChoice1" name="verChoice" value={verChoice1} onChange={e=>changeChoiceVer(e)} checked={choiceVer === verChoice1}></input>
                <label htmlFor="verChoice1">{verChoice1}</label>
                <input type="radio" id="verChoice2" name="verChoice" value={verChoice2} onChange={e=>changeChoiceVer(e)} checked={choiceVer === verChoice2}></input>
                <label htmlFor="verChoice2">{verChoice2}</label>
                <input type="radio" id="verChoice3" name="verChoice" value={verChoice3} onChange={e=>changeChoiceVer(e)} checked={choiceVer === verChoice3}></input>
